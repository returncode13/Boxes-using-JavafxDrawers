...
public class AnchorController {
    ...
    void setView(AnchorNode nd,AnchorPane interactivePane) {
       ...
       System.out.println("anchor.AnchorController.setView() Mouse Dragged on "+model.id%1000);
       ...
       e.consume();
         ...
         node.setOnDragDetected(e->{
            System.out.println("anchor.AnchorController.setView() DragDetected "+model.id%1000);
            node.startFullDrag();
        e.consume();
        });
