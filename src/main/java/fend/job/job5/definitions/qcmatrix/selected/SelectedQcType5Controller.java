...
import fend.job.job5.definitions.qcmatrix.QcMatrixType5Model;
import fend.job.job5.definitions.qcmatrix.QcMatrixType5View;
...
public class SelectedQcType5Controller {
    ...
    void setModel(SelectedQcType5Model model) {
    ...
    void setView(SelectedQcType5View vw) {
        view=vw;
    ...
    private void setupAddQcDrawer(JFXDrawer drawer,JFXButton button){
         ...
         QcMatrixType5Model qcmatmodel=new QcMatrixType5Model(job,model); 
    ...
    private ChangeListener<Boolean> UPDATE_LIST_LISTENER=new ChangeListener<Boolean>() {
        ...
        public void changed(ObservableValue<? extends Boolean> observable, Boolean oldValue, Boolean newValue) {
            ...
            Job job=SelectedQcType5Controller.this.job.getDatabaseJob();
