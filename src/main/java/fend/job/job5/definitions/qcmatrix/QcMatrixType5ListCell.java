 ...
 */
public class QcMatrixType5ListCell extends JFXListCell<QcMatrixRowType5Model>{
    HBox hbox=new HBox();
    ...
    @Override
    protected void updateItem(QcMatrixRowType5Model qctype,boolean empty){
