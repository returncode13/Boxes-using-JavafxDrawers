...
public class SelectedQcType2Controller {
    ...
    void setModel(SelectedQcType2Model model) {
    ...
    void setView(SelectedQcType2View vw) {
        view=vw;
    ...
    private void setupAddQcDrawer(JFXDrawer drawer,JFXButton button){
         ...
         QcMatrixType2Model qcmatmodel=new QcMatrixType2Model(job,model);
    ...
    private ChangeListener<Boolean> UPDATE_LIST_LISTENER=new ChangeListener<Boolean>() {
        ...
        public void changed(ObservableValue<? extends Boolean> observable, Boolean oldValue, Boolean newValue) {
            ...
            Job job=SelectedQcType2Controller.this.job.getDatabaseJob();
