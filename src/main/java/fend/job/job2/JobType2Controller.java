...
import fend.job.job2.definitions.JobDefinitionsType2Model;
import fend.job.job2.definitions.JobDefinitionsType2View;
...
//checkForHeaders=new SimpleBooleanProperty(false);
    ...
    void setView(JobType2View vw,AnchorPane interactivePane) {
        ...
        drawer.setId("LEFT");
        JobDefinitionsType2Model bdmodel=new JobDefinitionsType2Model();
        JobDefinitionsType2View bdview=new JobDefinitionsType2View(bdmodel,this.model);
  ...
  **/
    ...
    private ChangeListener<Boolean> CURRENT_JOB_DELETE_LISTENER=new ChangeListener<Boolean>() {
        ...
        public void changed(ObservableValue<? extends Boolean> observable, Boolean oldValue, Boolean newValue) {
            ...
            System.out.println("fend.job.job2.JobType1Controller.CURRENT_JOB_DELETE_LISTENER: deleting  all qc comments related to this job");
            deleteAllCommentsRelatedToJob();
            System.out.println("fend.job.job2.JobType1Controller.CURRENT_JOB_DELETE_LISTENER: deleting  all user preferences related to this job");
            deleteAllUserPreferencesRelatedToJob();
            
            System.out.println("fend.job.job2.JobType1Controller.CURRENT_JOB_DELETE_LISTENER: deleting all qcs related to this job");
            deleteAllQcsRelatedToJob();
            System.out.println("fend.job.job2.JobType1Controller.CURRENT_JOB_DELETE_LISTENER: deleting doubts related to this job");
