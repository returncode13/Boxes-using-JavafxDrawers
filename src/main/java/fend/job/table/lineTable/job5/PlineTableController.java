...
import fend.job.table.context.log.HeaderLogModel;
import fend.job.table.context.log.HeaderLogView;
import fend.job.table.context.log.VersionLogsModel;
...
public class PlineTableController extends Stage{
    ...
    void setModel(PlineTableModel item) {
    ...
    void setView(PlineTableView vw) {
        view=vw;
        ...
        treetableView.setRowFactory(ttv->{
         ...
         chooseThisHeader.setOnAction(evt->{
             ...
             Pheader h=headerService.getPheader(id);
             h.setChosen(true);
             headerService.updateHeader(h.getpHeaderId(), h);
         ...
         showLogsMenuItem.setOnAction(e->{
             ...
             Task<String> loghTask=new Task<String>(){
                    ...
                    protected String call() throws Exception {
                        ...
                        return "Finished extracting logs for : "+h.getpHeaderId();
           ...
           final  WorkFlowDifferenceModel workFlowDifferenceModel=new WorkFlowDifferenceModel();
             ...
             Task<String> workflowTask=new Task<String>(){
                    ...
                    protected String call() throws Exception {
                        ...
                        System.out.println(".call(): got "+workflows.size()+" for headerID: "+h.getpHeaderId()+" vol: "+v.getId());
                        ...
                        workFlowDifferenceModel.setChosenPHdr(h);
