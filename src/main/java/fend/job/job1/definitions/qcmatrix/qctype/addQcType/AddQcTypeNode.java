 ...
 */
package fend.job.job1.definitions.qcmatrix.qctype.addQcType;
...
public class AddQcTypeNode extends AnchorPane{
    ...
    public AddQcTypeNode(AddQcTypeModel ism){
         this.location=getClass().getClassLoader().getResource("fxml/job1/definitions/qcmatrix/addqctype/addQcType.fxml"); 
