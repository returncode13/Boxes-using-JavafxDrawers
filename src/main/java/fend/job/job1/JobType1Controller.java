...
parent.addChild(model);*/
                    ...
                    System.out.println("fend.job.job1.JobType1Controller.setView(): Size of The parent job "+ dbParent.getId()+" "+dbParent.getNameJobStep() + "  Ancestors: "+Ap.size());
                    System.out.println("fend.job.job1.JobType1Controller.setView(): Size of The child job "+ dbjob.getId()+" "+dbjob.getNameJobStep() + "  Ancestors: "+Ac.size());
                    System.out.println("fend.job.job1.JobType1Controller.setView(): Size of The parent job "+ dbParent.getId()+" "+dbParent.getNameJobStep() + "  Descendants: "+Dp.size());
                    System.out.println("fend.job.job1.JobType1Controller.setView(): Size of The childs job "+ dbjob.getId()+" "+dbjob.getNameJobStep() + "  Descendants: "+Dc.size());
                    ...
                    if((parentIsAnAncestor=ancestorService.getAncestorFor(dbjob, dbParent))==null){
                        ...
                        System.out.println("fend.job.job1.JobType1Controller.setView() Created an new Ancestor for job "+dbjob.getNameJobStep()+" and ancestor  "+dbParent.getNameJobStep());
                        Ac.add(parentIsAnAncestor);
                        System.out.println("fend.job.job1.JobType1Controller.setView(): Added ");
                    }else{
                         System.out.println("fend.job.job1.JobType1Controller.setView() Found an  Ancestor Entry existing for job "+dbjob.getNameJobStep()+" and ancestor  "+dbParent.getNameJobStep());
                    ...
                    for(Ancestor ap:Ap){                        //add all the ancestors of parents to the jobs list of ancestors
                        ...
                        if((jobAncestor=ancestorService.getAncestorFor(dbjob, ancestorToBeAdded))==null){
                            ...
                            System.out.println("fend.job.job1.JobType1Controller.setView() creating new Ancestor for job "+dbjob.getNameJobStep()+" new Ancestor added: "+ancestorToBeAdded.getNameJobStep());
                            Ac.add(jobAncestor);
                        }else{
                            System.out.println("fend.job.job1.JobType1Controller.setView() Found an  Ancestor Entry existing for job "+dbjob.getNameJobStep()+" and ancestor "+ancestorToBeAdded.getNameJobStep());
                    ...
                    if((currentJobIsADescendant=descendantService.getDescendantFor(dbParent, dbjob))==null){
                        ...
                        descendantService.addDescendant(currentJobIsADescendant);
                         System.out.println("fend.job.job1.JobType1Controller.setView() creating new Descendant for job "+dbParent.getNameJobStep()+" new Descendant added: "+dbjob.getNameJobStep());
                        ...
                        Set<Ancestor> ancestorsInJobsDescendant=jobsDescendant.getAncestors();
                            ...
                            for(Ancestor anc:Ac){
                                ...
                                if((jobAncestor=ancestorService.getAncestorFor(jobsDescendant, ancestorJobToBeAdded))==null){
                                    ...
                                    ancestorService.addAncestor(jobAncestor);
                                    System.out.println("fend.job.job1.JobType1Controller.setView() creating new Ancestor for job "+jobsDescendant.getNameJobStep()+" new Ancestor added: "+ancestorJobToBeAdded.getNameJobStep());
                                    ancestorsInJobsDescendant.add(jobAncestor);
                                }else{
                                     System.out.println("fend.job.job1.JobType1Controller.setView() Found an  Ancestor Entry existing for job "+jobsDescendant.getNameJobStep()+" and ancestor "+ancestorJobToBeAdded.getNameJobStep());
                                }
                            }
                            
                            jobsDescendant.setAncestors(ancestorsInJobsDescendant);
                            /*for(Ancestor aijd:ancestorsInJobsDescendant){
                            ancestorService.updateAncestor(aijd.getId(), aijd);
                            }*/
                    ...
                    for(Ancestor parentAncestorEntry:Ap){
                        ...
                        for(Descendant desc:Dp){                    //add all of the parents descendants to the parents ancestors
                            ...
                            if((parentDescendant=descendantService.getDescendantFor(parentsAncestor,descendantToBeAdded))==null){
                                ...
                                System.out.println("fend.job.job1.JobType1Controller.setView(): creating new Descendant for job "+parentsAncestor.getNameJobStep()+" new Descendant added: "+descendantToBeAdded.getNameJobStep());
                                descendantsInParentsAncestor.add(parentDescendant);
                            }else{
                                System.out.println("fend.job.job1.JobType1Controller.setView(): found a Descendant Entry existing for job "+parentsAncestor.getNameJobStep()+" and descendant "+descendantToBeAdded.getNameJobStep());
