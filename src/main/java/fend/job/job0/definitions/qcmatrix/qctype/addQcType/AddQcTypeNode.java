 ...
 */
package fend.job.job0.definitions.qcmatrix.qctype.addQcType;
...
public class AddQcTypeNode extends AnchorPane{
    ...
    public AddQcTypeNode(AddQcTypeModel ism){
         this.location=getClass().getClassLoader().getResource("fxml/job/definitions/qcmatrix/addqctype/addQcType.fxml"); 
