 ...
 */
package fend.job.job4.definitions.qcmatrix.qctype.addQcType;
...
public class AddQcTypeNode extends AnchorPane{
    ...
    public AddQcTypeNode(AddQcTypeModel ism){
         this.location=getClass().getClassLoader().getResource("fxml/job4/definitions/qcmatrix/addqctype/addQcType.fxml"); 
