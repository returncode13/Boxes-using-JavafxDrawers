...
public class SelectedQcType4Controller {
    ...
    void setModel(SelectedQcType4Model model) {
    ...
    void setView(SelectedQcType4View vw) {
        view=vw;
    ...
    private void setupAddQcDrawer(JFXDrawer drawer,JFXButton button){
         ...
         QcMatrixType4Model qcmatmodel=new QcMatrixType4Model(job,model);
    ...
    private ChangeListener<Boolean> UPDATE_LIST_LISTENER=new ChangeListener<Boolean>() {
        ...
        public void changed(ObservableValue<? extends Boolean> observable, Boolean oldValue, Boolean newValue) {
            ...
            Job job=SelectedQcType4Controller.this.job.getDatabaseJob();
