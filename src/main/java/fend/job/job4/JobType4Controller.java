 ...
 */
public class JobType4Controller implements JobType0Controller{
    final String expand=">";
    final String collapse="<";
    private AnchorPane interactivePane;
    private JobType4Model model;
    private JobType4View node;
    private Job dbjob;
    ...
    private void setupMenu() {
        ...
        addAChildJob.setOnAction(new EventHandler<ActionEvent>() {
            ...
            //    System.out.println(".handle(): Add a jobdotEdge here");
                ...
                ParentChildEdgeView pcdn=new ParentChildEdgeView(pcdm, node, JobType4Controller.this.interactivePane);
