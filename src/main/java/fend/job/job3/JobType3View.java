 ...
 */
public class JobType3View extends AnchorPane implements JobType0View{
    private  JobType3Model model;
    private JobType3Controller  controller;
    ...
    public JobType3View(JobType3Model item,AnchorPane interactivePane){
        ...
        this.location=getClass().getClassLoader().getResource("fxml/job/front/job3_1.fxml"); 
           ...
           fXMLLoader=new FXMLLoader();
            ...
            try{
                ...
                controller=(JobType3Controller)fXMLLoader.getController();
