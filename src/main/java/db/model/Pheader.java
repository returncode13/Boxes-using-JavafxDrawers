 ...
 * 
 * Header made available for other s/w (e.g. obpdeliverables) to read from
 * 
 */
@Entity
@Table(name="p_header",schema = "public")
public class Pheader implements Serializable{
    @Id
    @GeneratedValue(strategy = GenerationType.IDENTITY)
    private Long pHeaderId;
    ...
    final Pheader other = (Pheader) obj;
    if (!Objects.equals(this.pHeaderId, other.pHeaderId)) {
    return false;
    }
    ...
    */
    ...
    public int hashCode() {
        int hash = 5;
        hash = 37 * hash + Objects.hashCode(this.pHeaderId);
        return hash;
    }
    ...
    public Long getpHeaderId() {
        return pHeaderId;
    }

    public void setpHeaderId(Long pHeaderId) {
